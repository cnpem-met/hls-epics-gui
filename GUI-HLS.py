...
class Window(Display):
    def __init__(self):
        ...
        self.checkPlots = [[self.check_R1S1L, self.check_R1S2L, self.check_R1S3L, self.check_R1S4L, self.check_R1S5L],
                           [self.check_R1S1T, self.check_R1S2T, self.check_R1S3T,
                               self.check_R1S4T, self.check_R1S5T],
                           [self.check_R2S1L, self.check_R2S2L, self.check_R2S3L,
                               self.check_R2S4L, self.check_R2S5L],
                           [self.check_R2S1T, self.check_R2S2T, self.check_R2S3T,
                               self.check_R2S4T, self.check_R2S5T],
                           [self.check_R3S1L, self.check_R3S2L, self.check_R3S3L,
                               self.check_R3S4L, self.check_R3S5L],
                           [self.check_R3S1T, self.check_R3S2T, self.check_R3S3T,
                               self.check_R3S4T, self.check_R3S5T],
                           [self.check_R4S1L, self.check_R4S2L, self.check_R4S3L,
                               self.check_R4S4L, self.check_R4S5L],
        ...
        self.plot.setTimeSpan(1800)#1800
        ...
        for i in range(8):
            for j in range(5):
                ...
                if (self.checkPlots[i][j].isChecked() and not curveCheck[0]):
                    curve = self.plot.addYChannel(y_channel="ca://"+channel.pvname, name=name, color=QColor(
    ...
    def updateTable(self):
        self.data_level = [[self.data_levelPV[0][0].get(), self.data_levelPV[0][1].get(), self.data_levelPV[0][2].get(), self.data_levelPV[0][3].get(), self.data_levelPV[0][4].get()],
                           [self.data_levelPV[1][0].get(), self.data_levelPV[1][1].get(), self.data_levelPV[1][2].get(
                           ), self.data_levelPV[1][3].get(), self.data_levelPV[1][4].get()],
                           [self.data_levelPV[2][0].get(), self.data_levelPV[2][1].get(), self.data_levelPV[2][2].get(
                           ), self.data_levelPV[2][3].get(), self.data_levelPV[2][4].get()],
        ...
        self.data_temp = [[self.data_tempPV[0][0].get(), self.data_tempPV[0][1].get(), self.data_tempPV[0][2].get(), self.data_tempPV[0][3].get(), self.data_tempPV[0][4].get()],
                          [self.data_tempPV[1][0].get(), self.data_tempPV[1][1].get(), self.data_tempPV[1][2].get(
                          ), self.data_tempPV[1][3].get(), self.data_tempPV[1][4].get()],
                          [self.data_tempPV[2][0].get(), self.data_tempPV[2][1].get(), self.data_tempPV[2][2].get(
                          ), self.data_tempPV[2][3].get(), self.data_tempPV[2][4].get()],
        ...
        for i in range(4):
            for j in range(5):
                item1 = QtWidgets.QTableWidgetItem(
                    str('%.3f' % self.data_level[i][j]))
                item1.setFlags(Qt.ItemIsDragEnabled |
                               Qt.ItemIsUserCheckable | Qt.ItemIsEnabled)
                item2 = QtWidgets.QTableWidgetItem(
                    str('%.3f' % self.data_temp[i][j]))
    ...
    def associatePvs(self):
        ...
        self.rack_state = [PV('state_rack1'), PV(
            'state_rack2'), PV('state_rack3'), PV('state_rack4')]
        self.data_levelPV = [[PV('TU-17C:SS-HLS-Ax04NE5:Level-Mon'), PV('TU-16C:SS-HLS-Ax01NE4:Level-Mon'), PV('TU-15C:SS-HLS-Ax59NE3:Level-Mon'), PV('TU-14C:SS-HLS-Ax57NE2:Level-Mon'), PV('TU-13C:SS-HLS-Ax54NE1:Level-Mon')],
                             [PV('TU-01C:SS-HLS-Ax18SE5:Level-Mon'), PV('TU-01C:SS-HLS-Ax16SE4:Level-Mon'), PV('TU-20C:SS-HLS-Ax14SE3:Level-Mon'), PV('TU-19C:SS-HLS-Ax12SE2:Level-Mon'), PV('TU-18C:SS-HLS-Ax09SE1:Level-Mon')],
                             [PV('TU-06C:SS-HLS-Ax33SW5:Level-Mon'), PV('TU-06C:SS-HLS-Ax31SW4:Level-Mon'), PV('TU-05C:SS-HLS-Ax29SW3:Level-Mon'), PV('TU-04C:SS-HLS-Ax27SW2:Level-Mon'), PV('TU-03C:SS-HLS-Ax24SW1:Level-Mon')],
                             [PV('TU-11C:SS-HLS-Ax48NW5:Level-Mon'), PV('TU-11C:SS-HLS-Ax46NW4:Level-Mon'), PV('TU-10C:SS-HLS-Ax44NW3:Level-Mon'), PV('TU-09C:SS-HLS-Ax42NW2:Level-Mon'), PV('TU-08C:SS-HLS-Ax39NW1:Level-Mon')]]
        self.data_tempPV = [[PV('TU-17C:SS-HLS-Ax04NE5:Temp-Mon'), PV('TU-16C:SS-HLS-Ax01NE4:Temp-Mon'), PV('TU-15C:SS-HLS-Ax59NE3:Temp-Mon'), PV('TU-14C:SS-HLS-Ax57NE2:Temp-Mon'), PV('TU-13C:SS-HLS-Ax54NE1:Temp-Mon')],
                             [PV('TU-01C:SS-HLS-Ax18SE5:Temp-Mon'), PV('TU-01C:SS-HLS-Ax16SE4:Temp-Mon'), PV('TU-20C:SS-HLS-Ax14SE3:Temp-Mon'), PV('TU-19C:SS-HLS-Ax12SE2:Temp-Mon'), PV('TU-18C:SS-HLS-Ax09SE1:Temp-Mon')],
                             [PV('TU-06C:SS-HLS-Ax33SW5:Temp-Mon'), PV('TU-06C:SS-HLS-Ax31SW4:Temp-Mon'), PV('TU-05C:SS-HLS-Ax29SW3:Temp-Mon'), PV('TU-04C:SS-HLS-Ax27SW2:Temp-Mon'), PV('TU-03C:SS-HLS-Ax24SW1:Temp-Mon')],
                             [PV('TU-11C:SS-HLS-Ax48NW5:Temp-Mon'), PV('TU-11C:SS-HLS-Ax46NW4:Temp-Mon'), PV('TU-10C:SS-HLS-Ax44NW3:Temp-Mon'), PV('TU-09C:SS-HLS-Ax42NW2:Temp-Mon'), PV('TU-08C:SS-HLS-Ax39NW1:Temp-Mon')]]

    def verifyRackState(self):
        current_state = [self.rack_state[0].get(), self.rack_state[1].get(
        ), self.rack_state[2].get(), self.rack_state[3].get()]
        ...
        # if (self.en_rack4.isChecked()):
            ...
            #     self.led_rack4.update()
            # else:
        self.led_rack4.brush.setColor(Qt.green)
        self.led_rack4.update()
